...
import styles from "../student/ActivityBarGraph.module.css";
import { useEffect, useState } from "react";
import apiClient from "../config/apiClient";

const ActivityBarGraphFac = () => {
  ...
  const barGraphData = async () => {
    ...
    try {
      ...
      const regId =
        ...
        userData.faculty_advisory_details[0].reg_id ||userData.faculty_advisory_details[1].reg_id;
...
export default ActivityBarGraphFac;
