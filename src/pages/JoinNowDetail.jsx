      ...
      const members = [
        {
          ...
          position: "Secretary",
          image:
            selectedSociety.media_details?.secretary_profile_pic_url ||
        ...
        },
        {
          ...
          image:
            selectedSociety.media_details?.join_secretary_profile_pic_url ||
            "/placeholder.svg?height=100&width=100",
        ...
        },
        {
          ...
          image:
            selectedSociety.media_details?.faculty_advisory_profile_pic_url ||
            "/placeholder.svg?height=100&width=100",
        ...
        },
        {
          ...
          image:
            selectedSociety.media_details?.co_advisor_profile_pic_url ||
            "/placeholder.svg?height=100&width=100",
      ...
      <div className="details-container">
        <div className="details-content">
          ...
          <div className="prize-section">
            <div className="prize-details">
              <div className="prize-label">
                {selectedSociety.about
                  ? selectedSociety.about.replace(/<\/?[^>]+(>|$)/g, "")
          ...
          <div className="category-tags-container">
            ...
            <div className="category-tags">
              {selectedSociety.categories &&
                selectedSociety.categories.split(",").map((category, index) => {
                  const colors = [
                    "#6b7280",
                    "#4b6bdd",
                    "#3e9d78",
        ...
        <div className="details-sidebar">
            ...
            <div className="stat-item">
              ...
              <div className="stat-details">
                ...
                <span className="stat-value">
                  {selectedSociety.membership_count || 0}
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="eligibility-section">
            <h3>Eligibility</h3>
            <p>
              {selectedSociety.eligibility
                ? selectedSociety.eligibility.replace(/<\/?[^>]+(>|$)/g, "")
                : "Open for any Discipline Students."}
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="events-container">
            ...
            {currentEvent.length > 3 && (
              <button
                className={`event-nav-button next ${
                  (currentEventPage + 1) * 3 >= currentEvent.length
                    ? "disabled"
                    : ""
                }`}
        ...
        <section className="events-section">
          ...
          <div className="events-container-with-nav">
            ...
            <div className="events-grid">
              {previousEvents
                .slice(previousEventPage * 3, previousEventPage * 3 + 3)
                .map((event, index) => (
            ...
            {previousEvents.length > 3 && (
              <button
                className={`event-nav-button next ${
                  (previousEventPage + 1) * 3 >= previousEvents.length
                    ? "disabled"
                    : ""
                }`}
            ...
            {committeeMembers.map((member, index) => (
              <div key={index} className="committee-card">
                <div className="committee-header">
                  ...
                  <span
                    className={`role-badge role-${member.position
                      .toLowerCase()
                      .replace(/\s+/g, "-")}`}
                  >
                    {member.position}
                ...
                <div className="committee-body">
                  ...
                  <h3 className="member-name">{member.dept_name}</h3>
                  <h3 className="member-name">{member.registration_name}</h3>
