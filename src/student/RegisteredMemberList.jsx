...
const RegisteredMemberApproval = () => {
  ...
  const handleStatusChange = async (memberId, regId, newStatus) => {
    setUpdatingMember(memberId); // Start loading
    ...
    try {
      ...
      setUpdatingMember(null); // Stop loading
    }
  };
  ...
  const handleDownloadExcel = () => {
    ...
    const filteredData = members.map(
      ({ reg_id, id, dept_id, session_code, member_id, ...rest }) => rest
    );
              ...
              filteredMembers.map((member) => (
                <tr key={member.member_id}>
                  ...
                  <td>
                    ...
                    >
                      {updatingMember === member.member_id ? (
