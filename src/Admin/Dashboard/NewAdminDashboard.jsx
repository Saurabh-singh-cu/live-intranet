...
//   // In a real implementation, you would filter data based on the filter prop (monthly/weekly)
...
//   // In a real implementation, you would filter data based on the filter prop (monthly/weekly)
//   // For this example, we'll just use the first 6 months of data
...
//               <span
//                 className={`${styles.eventType} ${styles[`eventType${event.type.charAt(0).toUpperCase() + event.type.slice(1)}`]}`}
//               >
...
//     // This is a simple implementation. In a real app, you would import icons from a library
//     return (
...
//       time: "2 hours ago",
//     },
//     { id: 2, title: "Event Approved", message: "Annual Cultural Fest has been approved", time: "5 hours ago" },
//     {
//       id: 3,
...
//       time: "1 day ago",
//     },
//     { id: 4, title: "Upcoming Deadline", message: "Registration for Hackathon closes tomorrow", time: "1 day ago" },
//     { id: 5, title: "System Update", message: "Dashboard will be under maintenance on Sunday", time: "2 days ago" },
//   ]
...
// PieChart Component - Updated version
          ...
          {data.map((item, index) => (
            <div key={index} className={styles.chartColumn}>
              ...
              <div 
                ...
                style={{ height: `${(item.barValue / maxBarValue) * 80}%` }}
              >
...
const NewAdminDashboard = () => {
  ...
  const entityTableData = [
    { id: 1, name: "Robotics Club", type: "Club", department: "Computer Science", members: 45, events: 12, status: "Active" },
    { id: 2, name: "IEEE Student Branch", type: "Professional Society", department: "Electrical Engineering", members: 78, events: 15, status: "Active" },
    { id: 3, name: "Drama Club", type: "Club", department: "Arts", members: 32, events: 8, status: "Active" },
    { id: 4, name: "Mechanical Society", type: "Department Society", department: "Mechanical Engineering", members: 56, events: 10, status: "Inactive" },
    { id: 5, name: "AI Research Group", type: "Community", department: "Computer Science", members: 28, events: 6, status: "Active" },
  ]
        ...
        <div className={styles.regularTabContent}>
          ...
          <div className={styles.twoColumnSection}>
            ...
            <div className={styles.columnCard}>
              <h3>Entity Growth</h3>
              <LineBarChart 
                data={defectReductionData} 
                title="Entity Growth & Reduction"
              />
            </div>
          </div>
        ...
        <div className={styles.regularTabContent}>
          ...
          <div className={styles.chartSection}>
            <div className={styles.chartCard}>
              ...
              <DataTable 
                data={[
                  { id: 1, name: "John Doe", email: "john.doe@example.com", role: "Student", lastLogin: "2025-04-26 09:45 AM", status: "Active" },
                  { id: 2, name: "Jane Smith", email: "jane.smith@example.com", role: "Faculty", lastLogin: "2025-04-26 08:30 AM", status: "Active" },
                  { id: 3, name: "Robert Johnson", email: "robert.j@example.com", role: "Secretary", lastLogin: "2025-04-25 04:15 PM", status: "Active" },
                  { id: 4, name: "Emily Davis", email: "emily.d@example.com", role: "Student", lastLogin: "2025-04-25 02:20 PM", status: "Inactive" },
                  { id: 5, name: "Michael Wilson", email: "michael.w@example.com", role: "Student", lastLogin: "2025-04-24 11:10 AM", status: "Suspended" },
                ]}
                columns={[
                  { header: "ID", accessor: "id" },
                  { header: "Name", accessor: "name" },
