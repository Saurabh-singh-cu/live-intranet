...
//     const requiredFields = ["student_sec_1_name", "student_sec_1_email", "student_sec_1_uid", "student_sec_1_mobile"]
//     const missingFields = requiredFields.filter((field) => !formData[field])
...
//     if (isValid) {
//       const tabs = ["universityBody", "advisoryBoardStudent", "advisoryBoardFaculty", "acknowledgement"]
...
//                         {formData.proposed_by === "STUDENT" ? "Student UID" : "Employee Code"}
//                       </label>
//                       <input
//                         className="form-input"
//                         type="text"
...
//                 <div className="form-row">
//                   <div className="form-group">
//                     <label className="form-label" htmlFor="student_sec_1_name">
...
//                   </div>
//                   <div className="form-group">
//                     <label className="form-label" htmlFor="student_sec_1_email">
//                       Student Secretary Email
//                     </label>
//                     <input
//                       className="form-input"
//                       type="email"
...
//                   </div>
//                   <div className="form-group">
//                     <label className="form-label" htmlFor="student_sec_1_mobile">
//                       Student Secretary Mobile
//                     </label>
//                     <div className="input-group">
//                       <span className="input-prefix">+91</span>
//                       <input
...
//                 <div className="form-row">
//                   <div className="form-group">
//                     <label className="form-label" htmlFor="student_advsec_1_name">
//                       Student Joint Secretary Name
//                     </label>
//                     <input
//                       className="form-input"
//                       type="text"
...
//                   </div>
//                   <div className="form-group">
//                     <label className="form-label" htmlFor="student_advsec_1_email">
//                       Student Joint Secretary Email
//                     </label>
//                     <input
//                       className="form-input"
//                       type="email"
...
//                   </div>
//                   <div className="form-group">
//                     <label className="form-label" htmlFor="student_advsec_1_uid">
//                       Student Joint Secretary UID
//                     </label>
//                     <input
//                       className="form-input"
//                       type="text"
...
//                   </div>
//                   <div className="form-group">
//                     <label className="form-label" htmlFor="student_advsec_1_mobile">
//                       Student Joint Secretary Mobile
//                     </label>
//                     <div className="input-group">
//                       <span className="input-prefix">+91</span>
//                       <input
...
//                 <div className="form-row">
//                   <div className="form-group">
//                     <label className="form-label" htmlFor="faculty_adv_1_name">
...
//                   </div>
//                   <div className="form-group">
//                     <label className="form-label" htmlFor="faculty_adv_1_email">
...
//                   </div>
//                   <div className="form-group">
//                     <label className="form-label" htmlFor="faculty_adv_1_empcode">
//                       Faculty Advisor Emp Code
//                     </label>
//                     <input
//                       className="form-input"
//                       type="text"
...
//                   </div>
//                   <div className="form-group">
//                     <label className="form-label" htmlFor="faculty_adv_1_mobile">
//                       Faculty Advisor Mobile
//                     </label>
//                     <div className="input-group">
//                       <span className="input-prefix">+91</span>
//                       <input
...
//                 <div className="form-row">
//                   <div className="form-group">
//                     <label className="form-label" htmlFor="faculty_coadv_1_name">
...
//                   </div>
//                   <div className="form-group">
//                     <label className="form-label" htmlFor="faculty_coadv_1_email">
//                       Faculty Co-Advisor Email
//                     </label>
//                     <input
//                       className="form-input"
//                       type="email"
...
//                   </div>
//                   <div className="form-group">
//                     <label className="form-label" htmlFor="faculty_coadv_1_empcode">
//                       Faculty Co-Advisor Emp Code
//                     </label>
//                     <input
//                       className="form-input"
//                       type="text"
...
//                   </div>
//                   <div className="form-group">
//                     <label className="form-label" htmlFor="faculty_coadv_1_mobile">
//                       Faculty Co-Advisor Mobile
//                     </label>
//                     <div className="input-group">
//                       <span className="input-prefix">+91</span>
//                       <input
...
//                     <ReactQuill theme="snow" value={formData.referal} onChange={handleQuillChange} />
//                   </div>
//                 </div>
...
//                   />
//                   <label htmlFor="acknowledge">I acknowledge and agree to the above statement</label>
//                 </div>
//               </div>
//             )}
