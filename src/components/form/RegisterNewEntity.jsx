              ...
              <div className="form-section">
                ...
                <div className="form-group">
                  <label className="form-label" htmlFor="department">
                    Owner Of The Entity <span className="required-star">*</span>
                  </label>
                  <select
                    id="department"
                    name="department"
                  ...
                  <div className="quill-container">
                    ...
                    <input
                     ...
                     onChange={handleQuillChange}
                      ...
                      maxLength={10}
                      placeholder="Enter if you have refral, If not, type N/A"
                    />
                  </div>
                </div>
...
//   // Replace ReactQuill onChange handler with Tiptap handler
...
//                   <label className="form-label">Have referral?</label>
//                   <div className="quill-container">
//                     {/* Replace ReactQuill with our Tiptap editor */}
//                     <TiptapEditor
//                       value={formData.referal}
