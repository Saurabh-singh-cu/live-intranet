...
const GuidelinesContent = () => (
  <div className={styles.instructionContent}>
    ...
    <p>
      <strong>
        [Registration Start: The process will open every year in the last week May till 2nd Weeks of June]
      </strong>
    </p>
    <p>
      The entity acts as a catalyst for employability, entrepreneurship, and continuous skill upgradation, supporting
      the broader mission of Skill India and university curriculum.
    </p>
    ...
    <div className={styles.instructionSection}>
      ...
      <ul>
        <li>
          All entities must follow this naming format: [Domain Name] – Chandigarh University [Club/Departmental
          Society/Community]
        </li>
        <li>
          The prefix should clearly reflect the domain or theme of the entity (e.g., Blockchain, Cybersecurity,
          Filmmaking, Mathematics).
        </li>
        <li>
          Example: If your entity is related to filmmaking, your entity name should be Filmmaking Chandigarh University
          Club/ Department Society/ Community.
        </li>
        <li>Two different entities cannot take the same prefix name.</li>
        <li>
          <strong>SDG Alignment:</strong> Each entity must align its vision, objectives, and activities with at least
          one and at most four of the United Nations Sustainable Development Goals (SDGs). Check the SDG:
    ...
    <div className={styles.instructionSection}>
      ...
      <ul>
        <li>Developing a mission statement is the first step in establishing your team's identity.</li>
        <li>The mission should reflect your domain and the SDGs you are aligned with.</li>
      ...
      <ul>
        <li>
          "To engage the students of [Entity Name] to use entrepreneurship and innovation to improve the world through
          experiential learning, fostering personal and professional development."
        </li>
        <li>
          "To improve the lives of people in our community by partnering with them on innovative initiatives to create a
          better, more sustainable impact on people, planet, and prosperity."
        </li>
      </ul>
      ...
      <ul>
        <li>
          <strong>Vision:</strong> Vision is the end result that you want to achieve. It is typically a general and
          overarching idea expressed clearly and concisely.
        </li>
        <li>
          <strong>Objectives:</strong> Objectives help understand WHAT needs to be done to achieve the goals. Objectives
          help team members maintain a focus and keep the momentum towards the goals.
        </li>
        <li>
          <strong>Strategy:</strong> A Strategy is a plan of action that outlines HOW each individual or team will work
          toward the clearly defined goals and objectives. Strategies are dynamic and can change over time.
        </li>
      </ul>
    </div>
    ...
    <div className={styles.instructionSection}>
      ...
      <ul>
        <li>
          <strong>Student Secretary:</strong> Must be in the final or pre-final year of study.
        </li>
        <li>
          <strong>Student Joint Secretary:</strong> Must be in the second year or above.
        </li>
        <li>
          <strong>Faculty Advisor:</strong> [Faculty Advisor can be Co-Curricular coordinator and adopt any one entity
          but cannot be a advisor for both entity simultaneously]
          <ul>
            <li>The advisor's domain knowledge should align with the domain of the entity.</li>
            <li>Must be from the department to which the entity is affiliated.</li>
            <li>Must have served at Chandigarh University for at least 6 months.</li>
          </ul>
        </li>
      </ul>
    </div>
    ...
    <div className={styles.instructionSection}>
      ...
      <ul>
        <li>
          <strong>For Renewal Process:</strong> Download the form and take signatures from authorities and submit it in
          the DAA Office.
        </li>
        <li>
          <strong>For New Entity Registration Process:</strong> Download the form and then submit it in the DAA Office
          then the interview will schedule if the club meets the university mission and vision then the same form needs
          to be signed by each authority.
        </li>
      </ul>
      <p>
        <strong>Note:</strong> When registering a new entity or renewing an existing one, the form will be automatically
        downloaded after clicking the submit button on the CU Intranet portal. A popup will appear while submitting the
        form, allow it otherwise the form will not be downloaded.
      </p>
      <p>
        <strong>Once submitted for approval, re-application will not be allowed for one academic year.</strong>
      </p>
    </div>
    ...
    <div className={styles.instructionSection}>
      ...
      <p>
        Once the entity is approved, the secretary and faculty advisor will receive the intranet portal rights on their
        emails for further processes.
      </p>
    </div>
...
const RegisterNewEntity = () => {
  ...
  const [isCoCurricularCoordinator, setIsCoCurricularCoordinator] = useState("inactive")
  ...
  const validateMobile = (mobile) => {
    ...
    return /^\d{10}$/.test(cleanMobile) && ["6", "7", "8", "9"].includes(cleanMobile.charAt(0))
  }
  ...
  const handleInputChange = (e) => {
    ...
    const finalValue = shouldConvertToUppercase(name) ? value.toUpperCase() : value
  ...
  const handleEntityNameBlur = () => {
    const selectedEntity = entityData.find((entity) => entity.entity_id.toString() === formData.entity)

    if (selectedEntity && formData.entity_name && !formData.entity_name.includes("CHANDIGARH UNIVERSITY")) {
      let suffix = ""
  ...
  const handleCoCurricularToggle = () => {
    const newValue = isCoCurricularCoordinator === "active" ? "inactive" : "active"
    ...
    switch (field) {
      ...
      case "proposer_name":
        if (!formData.proposer_name) {
          return `${formData.proposed_by === "STUDENT" ? "Student" : "Faculty"} name is required`
      ...
      case "emp_code":
        if (!formData.emp_code) {
          return formData.proposed_by === "STUDENT" ? "Student UID is required" : "Employee code is required"
        } else if (formData.proposed_by === "STUDENT" && !validateUID(formData.emp_code)) {
          return "UID must not contain special characters"
        } else if (formData.proposed_by === "STUDENT" && formData.emp_code.length < 5) {
          return "UID must be at least 5 characters"
        } else if (formData.proposed_by === "FACULTY" && !/^[a-zA-Z0-9-]+$/.test(formData.emp_code)) {
      ...
      case "department":
        return formData.department ? "" : "Please select responsible department"
      ...
      case "student_sec_1_name":
        if (!formData.student_sec_1_name) {
          ...
          return "Name should contain only letters, spaces, and periods"
        } else if (checkDuplicates("name", formData.student_sec_1_name, "student_sec_1_name")) {
      ...
      case "student_sec_1_email":
        if (!formData.student_sec_1_email) {
          ...
          return "Please enter a valid email address"
        } else if (checkDuplicates("email", formData.student_sec_1_email, "student_sec_1_email")) {
      ...
      case "student_sec_1_uid":
        if (!formData.student_sec_1_uid) {
          ...
          return "UID must not contain special characters"
        } else if (checkDuplicates("uid", formData.student_sec_1_uid, "student_sec_1_uid")) {
          return "This UID is already used in another field"
        }
        return ""

      case "student_sec_1_mobile":
        if (!formData.student_sec_1_mobile || formData.student_sec_1_mobile.trim() === "") {
          return "Student secretary mobile is required"
        } else if (!validateMobile(formData.student_sec_1_mobile)) {
          return "Mobile number must be exactly 10 digits and start with 6, 7, 8, or 9"
        } else if (checkDuplicates("mobile", formData.student_sec_1_mobile, "student_sec_1_mobile")) {
          return "This mobile number is already used in another field"
        }
        return ""

      case "student_sec_1_dept":
        return formData.student_sec_1_dept ? "" : "Student secretary department is required"

      // Student joint secretary validations with duplicate checks
      case "student_advsec_1_name":
        if (
          formData.student_advsec_1_name &&
          checkDuplicates("name", formData.student_advsec_1_name, "student_advsec_1_name")
        ) {
          return "This name is already used in another field"
        }
        return ""
      ...
      case "student_advsec_1_email":
        if (formData.student_advsec_1_email && !validateEmail(formData.student_advsec_1_email)) {
          return "Please enter a valid email address"
        } else if (
          formData.student_advsec_1_email &&
          checkDuplicates("email", formData.student_advsec_1_email, "student_advsec_1_email")
        ) {
          return "This email is already used in another field"
        }
        return ""
      ...
      case "student_advsec_1_uid":
        if (formData.student_advsec_1_uid && !validateUID(formData.student_advsec_1_uid)) {
          return "UID must not contain special characters"
        } else if (
          formData.student_advsec_1_uid &&
          checkDuplicates("uid", formData.student_advsec_1_uid, "student_advsec_1_uid")
        ) {
          return "This UID is already used in another field"
        }
        return ""
      ...
      case "student_advsec_1_mobile":
        if (formData.student_advsec_1_mobile && !validateMobile(formData.student_advsec_1_mobile)) {
          return "Mobile number must be exactly 10 digits and start with 6, 7, 8, or 9"
        } else if (
          formData.student_advsec_1_mobile &&
          checkDuplicates("mobile", formData.student_advsec_1_mobile, "student_advsec_1_mobile")
        ) {
          return "This mobile number is already used in another field"
        }
        return ""
      ...
      case "faculty_adv_1_name":
        ...
        } else if (checkDuplicates("name", formData.faculty_adv_1_name, "faculty_adv_1_name")) {
          return "This name is already used in another field"
        }
        return ""
      ...
      case "faculty_adv_1_email":
        if (!formData.faculty_adv_1_email) {
          ...
          return "Please enter a valid email address"
        } else if (checkDuplicates("email", formData.faculty_adv_1_email, "faculty_adv_1_email")) {
          return "This email is already used in another field"
        }
        return ""
      ...
      case "faculty_adv_1_empcode":
        ...
        } else if (checkDuplicates("uid", formData.faculty_adv_1_empcode, "faculty_adv_1_empcode")) {
          return "This employee code is already used in another field"
        }
        return ""

      case "faculty_adv_1_mobile":
        if (!formData.faculty_adv_1_mobile || formData.faculty_adv_1_mobile.trim() === "") {
          return "Faculty advisor mobile is required"
        } else if (!validateMobile(formData.faculty_adv_1_mobile)) {
          return "Mobile number must be exactly 10 digits and start with 6, 7, 8, or 9"
        } else if (checkDuplicates("mobile", formData.faculty_adv_1_mobile, "faculty_adv_1_mobile")) {
          return "This mobile number is already used in another field"
        }
        return ""

      case "faculty_adv_1_dept":
        return formData.faculty_adv_1_dept ? "" : "Faculty advisor department is required"

      // Faculty co-advisor validations with duplicate checks
      case "faculty_coadv_1_name":
        if (
          formData.faculty_coadv_1_name &&
          checkDuplicates("name", formData.faculty_coadv_1_name, "faculty_coadv_1_name")
        ) {
          return "This name is already used in another field"
        }
        return ""
      ...
      case "faculty_coadv_1_email":
        if (formData.faculty_coadv_1_email && !validateEmail(formData.faculty_coadv_1_email)) {
          return "Please enter a valid email address"
        } else if (
          formData.faculty_coadv_1_email &&
          checkDuplicates("email", formData.faculty_coadv_1_email, "faculty_coadv_1_email")
        ) {
          return "This email is already used in another field"
        }
        return ""
      ...
      case "faculty_coadv_1_empcode":
        if (
          ...
          checkDuplicates("uid", formData.faculty_coadv_1_empcode, "faculty_coadv_1_empcode")
        ) {
          return "This employee code is already used in another field"
        }
        return ""
      ...
      case "faculty_coadv_1_mobile":
        if (formData.faculty_coadv_1_mobile && !validateMobile(formData.faculty_coadv_1_mobile)) {
          return "Mobile number must be exactly 10 digits and start with 6, 7, 8, or 9"
        } else if (
          formData.faculty_coadv_1_mobile &&
          checkDuplicates("mobile", formData.faculty_coadv_1_mobile, "faculty_coadv_1_mobile")
        ) {
          return "This mobile number is already used in another field"
        }
        return ""
  ...
  const validateForm = () => {
    ...
    if (!acknowledgement.agreed) {
      validationErrors.acknowledgement = "You must acknowledge the statement to proceed"
      isValid = false
  ...
  const generatePDF = (entcrId) => {
    ...
    const entityName =
      entityData?.find((e) => e.entity_id.toString() === formData.entity?.toString())?.entity_name || "N/A"
    ...
    const responsibleDeptName =
      departments?.find((d) => d.dept_id.toString() === formData.department?.toString())?.dept_name || "N/A"
    ...
    const studentDeptName =
      departments?.find((d) => d.dept_id.toString() === formData.student_sec_1_dept?.toString())?.dept_name || "N/A"
    ...
    const jointDeptName =
      departments?.find((d) => d.dept_id.toString() === formData.student_advsec_1_dept?.toString())?.dept_name || "N/A"
    ...
    addLeft("Co-Curricular Coordinator:", isCoCurricularCoordinator === "active" ? "Yes" : "No")
    const facultyDeptName =
      departments?.find((d) => d.dept_id.toString() === formData.faculty_adv_1_dept?.toString())?.dept_name || "N/A"
    ...
    const coAdvisorDeptName =
      departments?.find((d) => d.dept_id.toString() === formData.faculty_coadv_1_dept?.toString())?.dept_name || "N/A"
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await apiClient.post("entity-requests/", modifiedPayload)
  ...
  return (
    <div className={styles.registrationContainer}>
      <div className={styles.registrationCard}>
        ...
        <form ref={formRef} onSubmit={handleSubmit} className={styles.registrationForm}>
         ...
         <div className={styles.formGroup}>
                ...
                <select
                  className={`${styles.formSelect} ${errors.entity && touched.entity ? styles.inputError : ""}`}
                  name="entity"
                ...
                {errors.entity && touched.entity && <div className={styles.errorMessage}>{errors.entity}</div>}
              </div>
              ...
              <div className={styles.formGroup}>
                ...
                <div className={styles.inputWithButton}>
                  <input
                    className={`${styles.formInput} ${
                      errors.entity_name && touched.entity_name ? styles.inputError : ""
                    }`}
                    type="text"
                    id="entity_name"
                    name="entity_name"
                ...
                {errors.entity_name && touched.entity_name && (
                  <div className={styles.errorMessage}>{errors.entity_name}</div>
                )}
              </div>
              ...
              <div className={styles.formGroup}>
                ...
                <input
                  className={`${styles.formInput} ${
                    errors.proposed_date && touched.proposed_date ? styles.inputError : ""
                  }`}
                  type="date"
                  id="proposed_date"
                  name="proposed_date"
                ...
                {errors.proposed_date && touched.proposed_date && (
                  <div className={styles.errorMessage}>{errors.proposed_date}</div>
                )}
              </div>
              ...
              <div className={styles.formGroup}>
                ...
                <select
                  className={`${styles.formSelect} ${
                    errors.proposed_by && touched.proposed_by ? styles.inputError : ""
                  }`}
                  name="proposed_by"
                ...
                {errors.proposed_by && touched.proposed_by && (
                  <div className={styles.errorMessage}>{errors.proposed_by}</div>
                )}
              </div>

              <div className={styles.formGroup}>
                <label className={styles.formLabel} htmlFor="department">
                  Responsible Department <span className={styles.requiredStar}>*</span>
                  <div className={styles.helperText}>(Department that will oversee this entity)</div>
                </label>
                <select
                  id="department"
                  name="department"
                  ...
                  className={`${styles.formSelect} ${errors.department && touched.department ? styles.inputError : ""}`}
                >
                ...
                <div className={styles.formGrid}>
                  <div className={styles.formGroup}>
                    <label className={styles.formLabel} htmlFor="proposer_name">
                      {formData.proposed_by === "STUDENT" ? "Student" : "Faculty"} Name{" "}
                      <span className={styles.requiredStar}>*</span>
                    </label>
                    <input
                      className={`${styles.formInput} ${
                        errors.proposer_name && touched.proposer_name ? styles.inputError : ""
                      }`}
                      type="text"
                      id="proposer_name"
                      name="proposer_name"
                    ...
                    {errors.proposer_name && touched.proposer_name && (
                      <div className={styles.errorMessage}>{errors.proposer_name}</div>
                    )}
                  </div>
                  <div className={styles.formGroup}>
                    <label className={styles.formLabel} htmlFor="proposer_email">
                      {formData.proposed_by === "STUDENT" ? "Student" : "Faculty"} Email{" "}
                      <span className={styles.requiredStar}>*</span>
                    </label>
                    <input
                      className={`${styles.formInput} ${
                        errors.proposer_email && touched.proposer_email ? styles.inputError : ""
                      }`}
                      type="email"
                      id="proposer_email"
                      name="proposer_email"
                    ...
                    {errors.proposer_email && touched.proposer_email && (
                      <div className={styles.errorMessage}>{errors.proposer_email}</div>
                    )}
                  </div>
                  {formData.proposed_by === "STUDENT" ? (
                    <div className={styles.formGroup}>
                      <label className={styles.formLabel} htmlFor="emp_code">
                        Student UID <span className={styles.requiredStar}>*</span>
                      </label>
                      <input
                        className={`${styles.formInput} ${
                          errors.emp_code && touched.emp_code ? styles.inputError : ""
                        }`}
                        type="text"
                        id="emp_code"
                        name="emp_code"
                  ...
                  <div className={styles.formGroup}>
                    <label className={styles.formLabel} htmlFor="mobile">
                      {formData.proposed_by === "STUDENT" ? "Student" : "Faculty"} Mobile Number{" "}
                      <span className={styles.requiredStar}>*</span>
                    </label>
                    <div className={styles.phoneInput}>
                      <span className={styles.phonePrefix}>+91</span>
                      <input
                        className={`${styles.formInput} ${errors.mobile && touched.mobile ? styles.inputError : ""}`}
                        type="tel"
                        id="mobile"
                        name="mobile"
                        ...
                        onChange={(e) => {
                          ...
                          handleInputChange({
                            target: {
                              name: "mobile",
                              value: newValue.length > 0 ? `+91${newValue}` : "",
                            },
                          })
                        }}
                    ...
                    {errors.mobile && touched.mobile && <div className={styles.errorMessage}>{errors.mobile}</div>}
                  </div>
                </div>
              </div>
            )}
            ...
            <div className={styles.sdgSection}>
              <h3 className={styles.subSectionTitle}>
                ...
                <span className={styles.helperText}>
                  (Minimum 1, Maximum 4. Quality Education SDG 4 is pre-selected)
                </span>
              </h3>
              <div className={styles.sdgGrid}>
                {sdgData &&
                  sdgData.map((sdg) => (
                    <div
                      key={sdg.sdg_id}
                      className={`${styles.sdgCard} ${selectedSDGs.includes(sdg.sdg_id) ? styles.sdgSelected : ""}`}
              ...
              {errors.selected_sdgs && touched.selected_sdgs && (
                <div className={styles.errorMessage}>{errors.selected_sdgs}</div>
              )}
            </div>
          </div>
          ...
          <div className={styles.formSection}>
            <div className={styles.sectionHeader}>
              <h2 className={styles.sectionTitle}>Mission, Vision & Objectives</h2>
            ...
            <div className={styles.formGroup}>
              <label className={styles.formLabel} htmlFor="mission">
                ...
                <span className={styles.charCounter}>{formData.mission.length}/300 characters</span>
              </label>
              <textarea
                className={`${styles.formTextarea} ${errors.mission && touched.mission ? styles.inputError : ""}`}
                id="mission"
                name="mission"
                ...
                rows={4}
              />
              {errors.mission && touched.mission && <div className={styles.errorMessage}>{errors.mission}</div>}
            </div>

            <div className={styles.formGroup}>
              <label className={styles.formLabel} htmlFor="vision">
                Vision <span className={styles.requiredStar}>*</span>
                <span className={styles.charCounter}>{formData.vision.length}/100 characters</span>
              </label>
              <textarea
                className={`${styles.formTextarea} ${errors.vision && touched.vision ? styles.inputError : ""}`}
                id="vision"
                name="vision"
                ...
                rows={2}
              />
              {errors.vision && touched.vision && <div className={styles.errorMessage}>{errors.vision}</div>}
            </div>

            <div className={styles.formGroup}>
              <label className={styles.formLabel}>
                Objectives <span className={styles.requiredStar}>*</span>
                <span className={styles.helperText}>(Minimum 3, Maximum 4 points)</span>
              </label>
              ...
              {objectivePoints.map((point, index) => (
                <div key={index} className={styles.objectivePointContainer}>
                  ...
                  <div className={styles.objectivePointInputWrapper}>
                    <input
                      className={`${styles.formInput} ${
                        errors.objectives && touched.objectives && index < 3 ? styles.inputError : ""
                      }`}
                      type="text"
                      value={point}
                      onChange={(e) => handleObjectivePointChange(index, e.target.value)}
                      onBlur={() => handleBlur("objectives")}
                      placeholder={`Enter objective ${index + 1} (max 90 characters)`}
                      maxLength={90}
                      disabled={index === 3 && objectivePoints[2].trim() === ""}
                    />
                    <span className={styles.charCounter}>{point.length}/90</span>
                  </div>
                </div>
              ))}
          ...
          <div className={styles.formSection}>
            ...
            <div className={styles.formCard}>
              ...
              <div className={styles.formGrid}>
                <div className={styles.formGroup}>
                  <label className={styles.formLabel} htmlFor="student_sec_1_name">
                    Name <span className={styles.requiredStar}>*</span>
                  </label>
                  <input
                    className={`${styles.formInput} ${
                      errors.student_sec_1_name && touched.student_sec_1_name ? styles.inputError : ""
                    }`}
                    type="text"
                  ...
                  {errors.student_sec_1_name && touched.student_sec_1_name && (
                    <div className={styles.errorMessage}>{errors.student_sec_1_name}</div>
                  )}
                </div>
                <div className={styles.formGroup}>
                  <label className={styles.formLabel} htmlFor="student_sec_1_email">
                    Email <span className={styles.requiredStar}>*</span>
                  </label>
                  <input
                    className={`${styles.formInput} ${
                      errors.student_sec_1_email && touched.student_sec_1_email ? styles.inputError : ""
                    }`}
                    type="email"
                  ...
                  {errors.student_sec_1_email && touched.student_sec_1_email && (
                    <div className={styles.errorMessage}>{errors.student_sec_1_email}</div>
                  )}
                </div>
                <div className={styles.formGroup}>
                  <label className={styles.formLabel} htmlFor="student_sec_1_uid">
                    UID <span className={styles.requiredStar}>*</span>
                  </label>
                  <input
                    className={`${styles.formInput} ${
                      errors.student_sec_1_uid && touched.student_sec_1_uid ? styles.inputError : ""
                    }`}
                    type="text"
                  ...
                  {errors.student_sec_1_uid && touched.student_sec_1_uid && (
                    <div className={styles.errorMessage}>{errors.student_sec_1_uid}</div>
                  )}
                </div>
                <div className={styles.formGroup}>
                  <label className={styles.formLabel} htmlFor="student_sec_1_mobile">
                  ...
                  <div className={styles.phoneInput}>
                    ...
                    <input
                      className={`${styles.formInput} ${
                        errors.student_sec_1_mobile && touched.student_sec_1_mobile ? styles.inputError : ""
                      }`}
                      type="tel"
                      id="student_sec_1_mobile"
                      name="student_sec_1_mobile"
                      value={formData.student_sec_1_mobile?.replace(/^\+91/, "")}
                      onChange={(e) => {
                        let newValue = e.target.value.replace(/\D/g, "")
                        if (newValue.length > 10) newValue = newValue.slice(0, 10)
                        handleInputChange({
                  ...
                  {errors.student_sec_1_mobile && touched.student_sec_1_mobile && (
                    <div className={styles.errorMessage}>{errors.student_sec_1_mobile}</div>
                  )}
                </div>
                <div className={styles.formGroup}>
                  <label className={styles.formLabel} htmlFor="student_sec_1_dept">
                  ...
                  <select
                    ...
                    className={`${styles.formSelect} ${
                      errors.student_sec_1_dept && touched.student_sec_1_dept ? styles.inputError : ""
                    }`}
                  >
                  ...
                  {errors.student_sec_1_dept && touched.student_sec_1_dept && (
                    <div className={styles.errorMessage}>{errors.student_sec_1_dept}</div>
                  )}
                </div>
              </div>
            </div>
            ...
            <div className={styles.formCard}>
              ...
              <div className={styles.formGrid}>
                <div className={styles.formGroup}>
                  <label className={styles.formLabel} htmlFor="student_advsec_1_name">
                    Name
                  </label>
                  <input
                    className={`${styles.formInput} ${
                      errors.student_advsec_1_name && touched.student_advsec_1_name ? styles.inputError : ""
                    }`}
                    type="text"
                    ...
                    style={{ textTransform: "uppercase" }}
                  />
                  {errors.student_advsec_1_name && touched.student_advsec_1_name && (
                    <div className={styles.errorMessage}>{errors.student_advsec_1_name}</div>
                  )}
                </div>
                <div className={styles.formGroup}>
                  <label className={styles.formLabel} htmlFor="student_advsec_1_email">
                    Email
                  </label>
                  <input
                    className={`${styles.formInput} ${
                      errors.student_advsec_1_email && touched.student_advsec_1_email ? styles.inputError : ""
                    }`}
                    type="email"
                    ...
                    style={{ textTransform: "uppercase" }}
                  />
                  {errors.student_advsec_1_email && touched.student_advsec_1_email && (
                    <div className={styles.errorMessage}>{errors.student_advsec_1_email}</div>
                  )}
                </div>
                <div className={styles.formGroup}>
                  <label className={styles.formLabel} htmlFor="student_advsec_1_uid">
                    UID
                  </label>
                  <input
                    className={`${styles.formInput} ${
                      errors.student_advsec_1_uid && touched.student_advsec_1_uid ? styles.inputError : ""
                    }`}
                    type="text"
                    ...
                    style={{ textTransform: "uppercase" }}
                  />
                  {errors.student_advsec_1_uid && touched.student_advsec_1_uid && (
                    <div className={styles.errorMessage}>{errors.student_advsec_1_uid}</div>
                  )}
                </div>
                <div className={styles.formGroup}>
                  <label className={styles.formLabel} htmlFor="student_advsec_1_mobile">
                    Phone
                  </label>
                  <div className={styles.phoneInput}>
                    <span className={styles.phonePrefix}>+91</span>
                    <input
                      className={`${styles.formInput} ${
                        errors.student_advsec_1_mobile && touched.student_advsec_1_mobile ? styles.inputError : ""
                      }`}
                      type="tel"
                      id="student_advsec_1_mobile"
                      name="student_advsec_1_mobile"
                      value={formData.student_advsec_1_mobile?.replace(/^\+91/, "")}
                      onChange={(e) => {
                        let newValue = e.target.value.replace(/\D/g, "")
                        if (newValue.length > 10) newValue = newValue.slice(0, 10)
                        handleInputChange({
                  ...
                  {errors.student_advsec_1_mobile && touched.student_advsec_1_mobile && (
                    <div className={styles.errorMessage}>{errors.student_advsec_1_mobile}</div>
                  )}
                </div>
                <div className={styles.formGroup}>
                  <label className={styles.formLabel} htmlFor="student_advsec_1_dept">
                    Department
                  </label>
                  <select
                    ...
                    className={`${styles.formSelect} ${
                      errors.student_advsec_1_dept && touched.student_advsec_1_dept ? styles.inputError : ""
                    }`}
                  >
                    <option value="">Select Department</option>
                    {departments.map((dep) => (
                  ...
                  {errors.student_advsec_1_dept && touched.student_advsec_1_dept && (
                    <div className={styles.errorMessage}>{errors.student_advsec_1_dept}</div>
                  )}
                </div>
              </div>
            </div>
          ...
          <div className={styles.formSection}>
            ...
            <div className={styles.formCard}>
                ...
                <div className={styles.switchContainer}>
                  <label className={styles.switchLabel}>
                    <span className={styles.makeIthigh}>
                      ARE YOU CO-CURRICULAR/COMPETITION COORDINATOR FOR NEXT SEMESTER
                    </span>
                    ...
                    <span
                      className={`${styles.switchStatus} ${
                        isCoCurricularCoordinator === "active" ? styles.greenText : styles.notGreen
                      }`}
                    >
                      {isCoCurricularCoordinator === "active" ? `Active 😊 ` : "Inactive 😐"}
                    </span>
                  </label>
                </div>
              </div>
              ...
              <div className={styles.formGrid}>
                <div className={styles.formGroup}>
                  <label className={styles.formLabel} htmlFor="faculty_adv_1_name">
                    Name <span className={styles.requiredStar}>*</span>
                  </label>
                  <input
                    className={`${styles.formInput} ${
                      errors.faculty_adv_1_name && touched.faculty_adv_1_name ? styles.inputError : ""
                    }`}
                    type="text"
                  ...
                  {errors.faculty_adv_1_name && touched.faculty_adv_1_name && (
                    <div className={styles.errorMessage}>{errors.faculty_adv_1_name}</div>
                  )}
                </div>
                <div className={styles.formGroup}>
                  <label className={styles.formLabel} htmlFor="faculty_adv_1_email">
                    Email <span className={styles.requiredStar}>*</span>
                  </label>
                  <input
                    className={`${styles.formInput} ${
                      errors.faculty_adv_1_email && touched.faculty_adv_1_email ? styles.inputError : ""
                    }`}
                    type="email"
                  ...
                  {errors.faculty_adv_1_email && touched.faculty_adv_1_email && (
                    <div className={styles.errorMessage}>{errors.faculty_adv_1_email}</div>
                  )}
                </div>
                <div className={styles.formGroup}>
                  <label className={styles.formLabel} htmlFor="faculty_adv_1_empcode">
                    Employee Code <span className={styles.requiredStar}>*</span>
                  </label>
                  <input
                    className={`${styles.formInput} ${
                      errors.faculty_adv_1_empcode && touched.faculty_adv_1_empcode ? styles.inputError : ""
                    }`}
                    type="text"
                    ...
                    style={{ textTransform: "uppercase" }}
                  />
                  {errors.faculty_adv_1_empcode && touched.faculty_adv_1_empcode && (
                    <div className={styles.errorMessage}>{errors.faculty_adv_1_empcode}</div>
                  )}
                </div>
                <div className={styles.formGroup}>
                  <label className={styles.formLabel} htmlFor="faculty_adv_1_mobile">
                    Phone <span className={styles.requiredStar}>*</span>
                  </label>
                  <div className={styles.phoneInput}>
                    <span className={styles.phonePrefix}>+91</span>
                    <input
                      className={`${styles.formInput} ${
                        errors.faculty_adv_1_mobile && touched.faculty_adv_1_mobile ? styles.inputError : ""
                      }`}
                      type="tel"
                      id="faculty_adv_1_mobile"
                      name="faculty_adv_1_mobile"
                      value={formData.faculty_adv_1_mobile?.replace(/^\+91/, "")}
                      onChange={(e) => {
                        let newValue = e.target.value.replace(/\D/g, "")
                        if (newValue.length > 10) newValue = newValue.slice(0, 10)
                        handleInputChange({
                  ...
                  {errors.faculty_adv_1_mobile && touched.faculty_adv_1_mobile && (
                    <div className={styles.errorMessage}>{errors.faculty_adv_1_mobile}</div>
                  )}
                </div>
                <div className={styles.formGroup}>
                  <label className={styles.formLabel} htmlFor="faculty_adv_1_dept">
                    Department <span className={styles.requiredStar}>*</span>
                  </label>
                  <select
                    ...
                    className={`${styles.formSelect} ${
                      errors.faculty_adv_1_dept && touched.faculty_adv_1_dept ? styles.inputError : ""
                    }`}
                  >
                    <option value="">Select Department</option>
                    {departments.map((dep) => (
                  ...
                  {errors.faculty_adv_1_dept && touched.faculty_adv_1_dept && (
                    <div className={styles.errorMessage}>{errors.faculty_adv_1_dept}</div>
                  )}
                </div>
              </div>
            </div>
            ...
            <div className={styles.formCard}>
              ...
              <div className={styles.formGrid}>
                <div className={styles.formGroup}>
                  <label className={styles.formLabel} htmlFor="faculty_coadv_1_name">
                    Name
                  </label>
                  <input
                    className={`${styles.formInput} ${
                      errors.faculty_coadv_1_name && touched.faculty_coadv_1_name ? styles.inputError : ""
                    }`}
                    type="text"
                    ...
                    style={{ textTransform: "uppercase" }}
                  />
                  {errors.faculty_coadv_1_name && touched.faculty_coadv_1_name && (
                    <div className={styles.errorMessage}>{errors.faculty_coadv_1_name}</div>
                  )}
                </div>
                <div className={styles.formGroup}>
                  <label className={styles.formLabel} htmlFor="faculty_coadv_1_email">
                    Email
                  </label>
                  <input
                    className={`${styles.formInput} ${
                      errors.faculty_coadv_1_email && touched.faculty_coadv_1_email ? styles.inputError : ""
                    }`}
                    type="email"
                    ...
                    style={{ textTransform: "uppercase" }}
                  />
                  {errors.faculty_coadv_1_email && touched.faculty_coadv_1_email && (
                    <div className={styles.errorMessage}>{errors.faculty_coadv_1_email}</div>
                  )}
                </div>
                <div className={styles.formGroup}>
                  <label className={styles.formLabel} htmlFor="faculty_coadv_1_empcode">
                    Employee Code
                  </label>
                  <input
                    className={`${styles.formInput} ${
                      errors.faculty_coadv_1_empcode && touched.faculty_coadv_1_empcode ? styles.inputError : ""
                    }`}
                    type="text"
                    ...
                    style={{ textTransform: "uppercase" }}
                  />
                  {errors.faculty_coadv_1_empcode && touched.faculty_coadv_1_empcode && (
                    <div className={styles.errorMessage}>{errors.faculty_coadv_1_empcode}</div>
                  )}
                </div>
                <div className={styles.formGroup}>
                  <label className={styles.formLabel} htmlFor="faculty_coadv_1_mobile">
                    Phone
                  </label>
                  <div className={styles.phoneInput}>
                    <span className={styles.phonePrefix}>+91</span>
                    <input
                      className={`${styles.formInput} ${
                        errors.faculty_coadv_1_mobile && touched.faculty_coadv_1_mobile ? styles.inputError : ""
                      }`}
                      type="tel"
                      id="faculty_coadv_1_mobile"
                      name="faculty_coadv_1_mobile"
                      value={formData.faculty_coadv_1_mobile?.replace(/^\+91/, "")}
                      onChange={(e) => {
                        let newValue = e.target.value.replace(/\D/g, "")
                        if (newValue.length > 10) newValue = newValue.slice(0, 10)
                        handleInputChange({
                  ...
                  {errors.faculty_coadv_1_mobile && touched.faculty_coadv_1_mobile && (
                    <div className={styles.errorMessage}>{errors.faculty_coadv_1_mobile}</div>
                  )}
                </div>
                <div className={styles.formGroup}>
                  <label className={styles.formLabel} htmlFor="faculty_coadv_1_dept">
                    Department
                  </label>
                  <select
                    ...
                    className={`${styles.formSelect} ${
                      errors.faculty_coadv_1_dept && touched.faculty_coadv_1_dept ? styles.inputError : ""
                    }`}
                  >
                    <option value="">Select Department</option>
                    {departments.map((dep) => (
                  ...
                  {errors.faculty_coadv_1_dept && touched.faculty_coadv_1_dept && (
                    <div className={styles.errorMessage}>{errors.faculty_coadv_1_dept}</div>
                  )}
                </div>
              </div>
            </div>
          ...
          <div className={styles.formSection}>
            ...
            <div className={styles.acknowledgementBox}>
              <p className={styles.acknowledgementText}>
                I acknowledge that the information provided in this form is accurate and complete to the best of my
                knowledge. I understand that submitting false or misleading information may result in the rejection of
                this proposal or other appropriate actions.
              </p>
            </div>
            ...
            <div className={styles.checkboxGroup}>
              ...
              {errors.acknowledgement && <div className={styles.errorMessage}>{errors.acknowledgement}</div>}
            </div>
          </div>
        </form>
        ...
        <div className={styles.formActionsFixed}>
          <button type="button" className={styles.btnOutline} onClick={handleClear}>
            Clear all
          </button>
          <button type="submit" className={styles.btnPrimary} disabled={isLoading} onClick={handleSubmit}>
      ...
      {/* Payload Modal */}
      <ModalGuide isOpen={isPayloadModalOpen} onClose={() => setIsPayloadModalOpen(false)}>
        <div className={styles.payloadModal}>
          <div className={styles.payloadHeader}>
            <h2>📋 Form Payload</h2>
            <button className={styles.copyButton} onClick={copyPayload} title="Copy to clipboard">
              <Copy size={16} />
              Copy
            </button>
          </div>
          <div className={styles.payloadContent}>
            <pre className={styles.payloadCode}>{submittedData || "No data submitted yet"}</pre>
          </div>
        </div>
      </ModalGuide>

      {/* Instruction Modal */}
      <ModalGuide isOpen={isInstructionModalOpen} onClose={() => setIsInstructionModalOpen(false)}>
        <GuidelinesContent />
      </ModalGuide>

      <button className={styles.helpButton} onClick={() => setIsHelpModalOpen(true)}>
        📚 Need Help?
      </button>

      <ModalGuide isOpen={isHelpModalOpen} onClose={() => setIsHelpModalOpen(false)}>
        <GuidelinesContent />
      </ModalGuide>
    </div>
  )
